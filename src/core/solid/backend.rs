...
use crate::core::shared::codegen::{CodeGenerator, CpuCodeGenerator};
use crate::core::shared::graph::Graph;

use cranelift_jit::JITModule;
use cranelift_module::Module;

/// Solid-style backend: compiles fused kernels for AOT programs.
///
/// Unlike `LiquidBackend` which JIT-compiles one kernel at a time,
/// `SolidBackend` compiles all kernels needed by a program and packages
