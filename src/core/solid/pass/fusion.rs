...
use crate::core::liquid::schedule::{build_schedule_with_policy, ScheduleItem};
use crate::core::shared::graph::NodeId;
use crate::core::solid::fusion_policy::SolidFusionPolicy;
...
/// Solid's policy is more aggressive than Liquid's, allowing multi-consumer
