...
use crate::core::shared::codegen::expr::{build_expression, ExprBuildContext};
use crate::core::shared::codegen::math::MathFuncRefs;
use crate::core::shared::codegen::tracker::{
...
pub struct KernelEmitInfo<'a> {
    ...
    pub input_trackers: &'a HashMap<NodeId, crate::core::shared::shape_tracker::ShapeTracker>,
    pub shape_source_map: &'a HashMap<NodeId, NodeId>,
    pub has_noncontiguous_trackers: bool,
    pub output_tracker: Option<&'a crate::core::shared::shape_tracker::ShapeTracker>,
