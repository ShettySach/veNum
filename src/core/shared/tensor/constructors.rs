...
impl<C: Context> Tensor<C> {
    ...
    pub fn from_slice(cx: &C, data: &[f32], shape: Vec<usize>) -> Self {
    ...
    pub fn from_slice_f64(cx: &C, data: &[f64], shape: Vec<usize>) -> Self {
    ...
    pub fn from_slice_i32(cx: &C, data: &[i32], shape: Vec<usize>) -> Self {
    ...
    pub fn from_slice_i64(cx: &C, data: &[i64], shape: Vec<usize>) -> Self {
    ...
    pub fn constant(cx: &C, value: f32, shape: Vec<usize>) -> Self {
        let graph = cx.graph();
        let id = graph
            .lock()
            .unwrap()
    ...
    pub fn constant_scalar(cx: &C, value: Scalar, shape: Vec<usize>) -> Self {
